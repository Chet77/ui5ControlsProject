function EAO (domain, bJson, sUsername, sPassword, bIsMobile) {
	//adding BusyDialog for use instead of BusyIndicator
	if(sap.ui.getCore().byId("busyDialog1") === undefined){
		new sap.m.BusyDialog("busyDialog1");
	}
	this.domain = domain;
	this.bJson = bJson;

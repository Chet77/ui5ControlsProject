 ...
 * @version {@link Navigation}
 */
Navigation.prototype.toDetailPage = function (sPage, oData, sTransitionName) {
	//check to see if sPage already exists in DOM
	var sId = Util.replaceAllInString(sPage, ".", "_");
	var page = sap.ui.getCore().byId(sId);
...
Navigation.prototype.backMasterPage = function (oBackData) {
	this.splitApp.backMaster(oBackData);
};

Navigation.prototype.backDetailPage = function (oBackData) {
...
Navigation.prototype.backPage = function (oBackData) {
